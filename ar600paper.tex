...
\subsection{Hardware architecture and kinematics}
...
\ref{tbl:DOFTable}) with 13 degrees of freedom in lower part including legs and
pelvis and 5-DOF hands. Head with sensors has 3 DOF. Palm asseblies have 5
...
Pelvis and torso are connected via rotational joint.

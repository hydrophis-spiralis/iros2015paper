...
Robot weights 55 kilograms, its  height is 155 cm.
...
with Rviz and Gazebo models. Motion planning is based on MoveIt! package
\cite{c3} that uses state-of-the-art planning libraries. One can test planning
